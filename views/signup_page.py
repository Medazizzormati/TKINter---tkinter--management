...
#  Beginner-friendly with clear labels.
# =============================================
...
class SignupPage(ctk.CTkFrame):
    ...
    def _build_card(self):
        """Build the signup form inside the card."""
    ...
    # --------------------------------------------------
    def _do_signup(self):
        """Validate inputs and call the signup callback."""
        username = self.username_entry.get().strip()
        email    = self.email_entry.get().strip()
        password = self.password_entry.get()
        confirm  = self.confirm_entry.get()

        # --- Simple validation (beginner-friendly messages) ---
        if not username:
