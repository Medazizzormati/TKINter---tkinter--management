...
class PaymentModal(ctk.CTkToplevel):
    ...
    def _build_payment_side(self):
        """Replacement for mock card generation: Konnect API initiation form"""
        frame = ctk.CTkFrame(self, fg_color=self.CARD, corner_radius=16, border_width=1, border_color=self.BORDER)
    ...
    def _initiate_konnect_payment(self):
        """Call Konnect API sandbox to get a payment URL"""
        ...
        payload = {
            ...
            "amount": int(self.total_price * 1000), # Conversion to millimes
            "token": "TND",
    ...
    def _process_payment(self):
        """Finalize order after user confirms payment in browser"""
    ...
    def _print_receipt(self):
        """Generates a professional PDF bill and opens it."""
        try:
